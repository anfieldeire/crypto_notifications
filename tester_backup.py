...
class Crypto:
    ...
    def read_config_file(self):
        ...
        with open('..\portfolio.txt') as f:
            ...
            for user_list in file_data:
                ...
                allusers_portfolio.append(user_porfolio)
            # print("all users portfolio")
            # print(allusers_portfolio)
    ...
    def get_portfolio_data(self):
        ...
        for each_dict in self.portfolio_amounts:
            print("Each dict {}".format(each_dict))
            user_portfolio = []
            for coin in self.data:
                if coin['symbol'] in each_dict:
                    print("coin found")
                    print(coin)
